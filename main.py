...
wea, temp,low,high = get_weather()
data = {"weather":{"value":wea},"temperature":{"value":tem},"love_days":{"value":get_count()},"birthday_left":{"value":get_birthday()},"words":{"value":get_words(), "color":get_random_color()}}
